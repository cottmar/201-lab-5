...
function sumAndMultiply(a,b,c){ 
  var sumAandB = sum(a,b)[0]
  var sumAandBandC = sum(sumAandB, c)[0]
  var productAandB = multiply(a,b)[0]
  var productAandBandC = multiply(productAandB, c)[0]
  var messageForThirdElement = a + ' and ' + b + ' and ' + c + ' sum to ' + sumAandBandC + '.';
  var messageForFourthElement = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + productAandBandC + '.';
    return [sumAandBandC, productAandBandC, messageForThirdElement, messageForFourthElement];
}
...
function sumArray(testArray) {
  var sumNumbersArray = sum(testArray[0], testArray[1])[0]
  var sumNumbersArrayAnd4 = sum(sumNumbersArray, testArray[2])[0]
  var messageQ4 = testArray + ' was passed in as an array of numbers, and ' + sumNumbersArrayAnd4 + ' is their sum.';
  return [sumNumbersArrayAnd4, messageQ4];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  var multiplyArray = [2,3,4];
  var productNumbersArray = multiply(multiplyArray[0], multiplyArray[1])[0]
  var productNumbersArrayAnd4 = multiply(productNumbersArray, multiplyArray[2])[0]
  var messageQ5 = 'The numbers ' + multiplyArray + ' have a product of ' + productNumbersArrayAnd4 + '.';
  return [productNumbersArrayAnd4, messageQ5];
}
